...
<tags:master pageTitle="Phohe List">
  ...
  <div class="row">
    <div class="container">
      ...
      <div class="container">
        Found <c:out value="${numberOfjewelrys}"/> jewelries.
      </div>
    </div>
  </div>
  <div class="panel"></div>
      ...
      <table class="table table-hover table-bordered text-center">
        ...
        <c:forEach var="jewelry" items="${jewelries}">
          <tr>
            ...
            <td class="align-middle">
              <a href="<c:url value="/productDetails/${jewelry.id}"/>">${jewelry.brand}</a>
            </td>
            <td class="align-middle">
              <a href="<c:url value="/productDetails/${jewelry.id}"/>">${jewelry.model}</a>
            </td>
            <td class="align-middle">
              <ul>
            ...
            <td class="align-middle">${jewelry.displaySizeInches}"</td>
            <td class="align-middle">$ ${jewelry.price}</td>
            <td class="align-middle">
