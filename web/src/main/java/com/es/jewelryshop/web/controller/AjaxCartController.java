package com.es.jewelryshop.web.controller;
...
public class AjaxCartController {
    ...
    @ResponseBody
    public CartAddDto addjewelry(@RequestBody @Valid CartItemDto cartItem,
                               BindingResult bindingResult) {
        CartAddDto message = new CartAddDto();
        if (!bindingResult.hasErrors()) {
            cartService.addjewelry(cartItem.getJewelryId(), cartItem.getQuantity());
        ...
        message.setJewelryId(cartItem.getJewelryId());
