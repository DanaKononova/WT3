...
import com.es.jewelryshop.web.controller.pages.CartPageController;
...
public class CartPageControllerTest {
    ...
    void testDeleteFromCart() {
        ...
        String viewName = cartPageController.deleteFromCart(jewelryId, mock(Model.class));

        assertEquals("cart", viewName);
        verify(cartService, times(1)).remove(jewelryId);
    }
}
